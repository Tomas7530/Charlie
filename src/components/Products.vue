<template>
    <div   class = "product"
        ...
        <div   class = "text-center" 
            ...
            <img   class = "image float-left col-6"
                    :src = "product.img" 
                    :alt = "product.alt"  />

            <p   class = "parag float-right col-6" >
                {{ product.description }}
            </p>

            <router-link   class = "creation link col-3 button"
                              to = "/custom"                         
                             tag = "button" >

                <h4   v-on:click ="custom($event)"
...
.product {
    ...
    box-shadow      : 5px 2px 2px 2px rgba(230, 230, 230, 0.9);
    padding         : 10px 10px;
    margin-top      : 12px;
    margin-left     : 12px;
    margin-right    : 12px;
